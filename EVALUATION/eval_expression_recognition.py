...
for em in emotions:
    ...
    export_csv = df.to_csv(r'/home/anapt/custom_loss_predictions_boot.csv', index=None, header=True)


def get_confusion_matrix():
    data = pd.read_csv("/home/anapt/custom_loss_predictions_boot.csv")
    ...
    plt.savefig("/home/anapt/confusion_custom_loss_boot.pdf")
