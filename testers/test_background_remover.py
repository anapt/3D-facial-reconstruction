...
src = cv2.imread('./DATASET/images/im_0.png', 1)
blurred = cv2.GaussianBlur(src, (5, 5), 0)

blurred_float = blurred.astype(np.float32) / 255.0
edgeDetector = cv2.ximgproc.createStructuredEdgeDetection("./DATASET/model.yml")
...
filter_out_salt_pepper_noise(edges_8u)
...
contour = find_significant_contour(edges_8u)
...
contour2 = find_significant_contour(mask2)
