...
def main():
    n = 1
    image_path = ("/home/anapt/PycharmProjects/thesis/DATASET/images/im_%d.png" % n)
    cutout_path = ("/home/anapt/PycharmProjects/thesis/DATASET/images/cutout/im_%d.png" % n)
    cropped_image_path = ("/home/anapt/PycharmProjects/thesis/DATASET/images/cropped/image_%d.png" % n)

    face = LandmarkDetection()
    face.cutout_mask(image_path, cutout_path)
